          ...
          <form className="flex w-full flex-col gap-7" onSubmit={handleSubmit}>
            <div className="flex flex-col gap-1">
              <Text size="lg" asChild>
                <label className="max-w-[80%]">HG</label>
              </Text>
              <TextField
                label=""
                variant="filled"
            ...
            <div className="flex flex-col gap-1">
              <Text size="lg" asChild>
                <label className="max-w-[80%]">HT</label>
              </Text>
              <TextField
                label=""
                variant="filled"
            ...
            <div className="flex flex-col gap-1">
              <Text size="lg" asChild>
                <label className="max-w-[80%]">TG</label>
              </Text>
              <TextField
                label=""
                variant="filled"
            ...
            <div className="flex flex-col gap-1">
              <Text size="lg" asChild>
                <label className="max-w-[80%]">HDL</label>
              </Text>
              <TextField
                label=""
                variant="filled"
            ...
            <div className="flex flex-col gap-1">
              <Text size="lg" asChild>
                <label className="max-w-[80%]">LDL</label>
              </Text>
              <TextField
                label=""
                variant="filled"
            ...
            <div className="flex flex-col gap-1">
              <Text size="lg" asChild>
                <label className="max-w-[80%]">Glicose</label>
              </Text>
              <TextField
                label=""
                variant="filled"
            ...
            <div className="flex flex-col gap-1">
              <Text size="lg" asChild>
                <label className="max-w-[80%]">
                  Quanto da renda é destinado à alimentação?
                </label>
              </Text>
              <TextField
                label=""
                variant="filled"
                value={formData.income_food}
                onChange={(event) =>
                  setFormDate({
                    ...formData,
                    income_food: event.target.value,
                  })
                }
              />
            </div>
            ...
            <div className="flex flex-col gap-1">
              <Text size="lg" asChild>
                <label className="max-w-[80%]">Tipo de moradia </label>
              </Text>
              <TextField
                label=""
                variant="filled"
                value={formData.type_housing}
                onChange={(event) =>
                  setFormDate({
                    ...formData,
                    type_housing: event.target.value,
                  })
                }
              />
            </div>
            ...
            <div className="flex flex-col gap-1">
              <Text size="lg" asChild>
                <label className="max-w-[80%]">Paga aluguel?</label>
              </Text>

              <RadioGroup
                value={formData.pay_rent}
                onChange={(event) =>
                  setFormDate({
                    ...formData,
                    pay_rent: event.target.value,
                  })
                }
                row
              >
